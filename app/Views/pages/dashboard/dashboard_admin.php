...
<div class="container mx-auto mt-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-green-100 p-4 rounded border border-green-500">
            ...
            <p class="text-3xl text-green-700">900</p>
        </div>
        ...
        <div class="bg-red-100 p-4 rounded border border-red-500">
            ...
            <p class="text-3xl text-red-700">12</p>
        </div>
    </div>
    ...
    <script>
        const getChartOptions = () => {
            return {
                ...
                labels: ["Membantu Teman", "Berkata Kasar kepada teman", "Tidak membawa buku"],
                dataLabels: {
                    enabled: true,
                    style: {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const last7DaysButton = document.getElementById("dropdownDefaultButton");
            const last7DaysDropdown = document.getElementById("lastDaysdropdown");

            last7DaysButton.addEventListener("click", function() {
                // Tambahkan logika atau tindakan yang ingin Anda lakukan saat tombol diklik di sini
                // Misalnya, buka atau tutup dropdown
                last7DaysDropdown.classList.toggle("hidden");
            });
        });
    </script>
    <?= $this->endSection(); ?>